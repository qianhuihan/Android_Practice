...
public class DrawActivity extends Activity {
    ...
    protected void saveBitmap() {
        try {
            ...
            Toast.makeText(DrawActivity.this, "保存图片成功",LENGTH_SHORT).show();
            ...
            Toast.makeText(DrawActivity.this, "保存图片失败", LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
    ...
    protected void resumeCanvas() {
        ...
        if (baseBitmap != null) {
            ...
            canvas.drawColor(Color.WHITE);
            iv_canvas.setImageBitmap(baseBitmap);
            Toast.makeText(DrawActivity.this, "清除画板成功，可以重新开始绘图", LENGTH_SHORT).show();
        }
    }
}
